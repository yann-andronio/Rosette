          ...
          <section>
            ...
            <div className="flex flex-wrap gap-3 mb-4">
              ...
              <button
                ...
                type="button"
                disabled={student?.sousetudiants[student?.sousetudiants?.length - 1]?.status_admissions =='suspendu'}
                className={`flex items-center gap-1 px-3 py-1.5 rounded-lg ${
                  student?.sousetudiants[student?.sousetudiants?.length - 1]?.status_admissions =='suspendu'? 'bg-gray-400 hover:cursor-not-allowed' : 'bg-[#895256] hover:bg-[#733935]' 
