...
const PrintOptionsModal: React.FC<PrintOptionsModalProps> = ({
  ...
  const isPrintAllowed = statusSelected === 'Incomplet' && yearSelected !== '0' && monthSelected !== "0"
      ...
      <div className="bg-white rounded-3xl shadow-2xl p-6 w-full max-w-lg mx-4">
        ...
        <div className="mb-6 text-gray-700">
          <p className="mb-4 text-gray-800">
            Vous êtes sur le point d’imprimer la liste des élèves selon le statut d’écolage.
          </p>
          ...
          <div className="grid grid-cols-3 gap-4 text-center mb-4">
            ...
            <div className="bg-[#FFF4E5] text-[#9F7126] font-semibold py-2 px-3 rounded-lg shadow-sm">
              Mois <br />{' '}
              <span className="text-lg">{monthSelected !== '0' ? monthSelected : 'Tout'}</span>
            </div>
            <div
