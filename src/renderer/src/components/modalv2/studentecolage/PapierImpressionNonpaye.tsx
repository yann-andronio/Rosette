...
interface PapierImpressionNonPayeProps {
    ...
    return (
      <div ref={ref} className="p-6 bg-white text-gray-900 font-sans text-sm leading-relaxed">
        <div className="mb-6 text-center border-b pb-3">
          <h1 className="text-2xl font-bold mb-1">Liste des élèves n’ayant pas payé l’écolage</h1>
          <p className="text-gray-700">
            Année scolaire :{' '}
            <span className="font-semibold">{yearSelected !== '0' ? yearSelected : '—'}</span> |
            Mois :{' '}
            <span className="font-semibold">{monthSelected !== '0' ? monthSelected : 'Tout'}</span>
          </p>
        </div>
...
export default PapierImpressionNonPaye
